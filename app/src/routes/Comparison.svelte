...
<style>
  .cmpbar { display: flex; align-items: center; gap: 12px; padding: 8px 14px; border-bottom: 1px solid var(--rule); font-size: 12px; }
  ...
  .cmp { display: grid; grid-template-columns: 1fr 1fr; height: calc(100vh - 92px); }
